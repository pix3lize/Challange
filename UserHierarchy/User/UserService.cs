...
namespace UserH.Services
{
    ...
    public class UserService
    {
        ...
        public List<int> lookUpRoleId = new List<int>();

        // Get list of role object from json file 
        public List<Role> setRoles(string path)
        {
            try
            {
        ...
        public string readMe(string path)
        {
            try
            {
                StreamReader sr = new StreamReader(path);
        ...
        public List<User> setUsers(string path)
        {
            try
            {
                StreamReader sr = new StreamReader(path);
        ...
        public string getSubOrdinates(int id)
        {
        ...
        public void hasChildren(int id)
        {
